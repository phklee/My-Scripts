...
function perception() {
  if [ $# -eq 2 ]; then
    ...
    rosbag record /driver/lidar/rs_80_packets/top_center \
      ...
      /radarprocess/fusion \
      /radarprocess/rear_raw_object \
      /radarprocess/rear_raw_object/text \
      /radarprocess/rear_object \
      /radarprocess/rear_object/text \
      /radarprocess/rear_cluster \
      /radarprocess/rear_cluster/text \
      /radarprocess/rear_track \
      /radarprocess/rear_track/text \
      /radarprocess/rear_fusion \
      /radarprocess/rear_fusion/text \
      /radar2cam/image \
      /radar2cam/front_radar_detections \
      /tpbusiness_cmd \
      /tpbusiness_debug \
      /tpbusiness_status \
      /tpcanfeedback \
      ...
      /lidar/debug/detection_bbox \
      /lidar/debug/detection_polygon \
      /lidar/debug/detection_points \
      /lidar/debug/detection_cube \
      /dogm/debug/no_ground_cloud \
      /dogm_cluster/dogmdet \
      /dogm_cluster/dogm_clouds \
      /dogm/detections_dogm \
      /fusion/semantic_image \
      /lidar2object/cam_det \
      /lidar2object/cam_trk \
      /lidar2object/cam_trk_polygon \
      /lidar2object/cam_trk_cells \
      /lidar2object/cam_trk_points \
      /lidar2object/cloudsImg \
      /lidar2object/cam_trk_detections \
      /lidar2object/detections_lidar \
      /lidar2object/detections_lidar_grids \
      /subfusion/detections_lidar \
      /subfusion/detections_radar \
      /subfusion/detections_dogm \
      /fusion/detections_lidar \
      /fusion/detections_radar \
      /fusion/detections_dogm \
      /mot_manager/matched_detections_lidar \
      /mot_manager/matched_lidar_dogm_grids \
      /fusion/matched_detections_lidar \
      /fusion/matched_detections_radar \
      /fusion/matched_detections_dogm \
